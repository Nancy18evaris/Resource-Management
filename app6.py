...
if uploaded_file is not None:
    ...
    if pudu_df.empty:
        ...
        exclude_cols = ['Unnamed: 0',
            ...
            'tokens_no_stop', 'manual_token_present', 'matched_manual_tokens', 'state', 'district', 'state_count', 'district_count',
            'Total_Workers', 'Total_Female_Workers', 'lon', 'lat', 'Total_Male_Workers'
        ]
