...
if uploaded_file is not None:
    ...
    if missing_cols:
        ...
        # Step 3: Split 'Worker Type' into 'Worker Category' and 'Area' for labeling
        ...
        # Step 4: Combine area and worker category for better labels
        melted['Group'] = melted['Area'] + ' - ' + melted['Worker Category']

        # Step 5: Plot interactive grouped bar chart
        fig = px.bar(
            melted,
            x='state',
