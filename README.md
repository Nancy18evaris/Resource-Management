...
- **Missing Value Handling**: Used imputation methods to fill missing data.
- **Outlier Detection & Handling**:
  - **Z-Score Method**
  - **IQR (Interquartile Range)**
  - **Winsorization** (to cap extreme outliers)
- **Skewness & Kurtosis Analysis**: Applied `log1p()` transformation for right-skewed data.
- **Feature Transformation**:
  - MultiLabelBinarizer for multi-class categorical features.
  - Text preprocessing for NLP tokenization.
...
- **Visualizations**:
  - Histograms, Bar Charts, KDE plots
  - Gender-wise and industry-wise worker distribution
  - State-wise industrial workforce mapping
...
- Used the **BERT tokenizer** for preprocessing industrial classification text:
  ```python
